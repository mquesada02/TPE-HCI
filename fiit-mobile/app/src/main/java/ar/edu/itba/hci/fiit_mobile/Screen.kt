...
sealed class Screen(val title: String, val icon: ImageVector, val route: String) {
    ...
    object RoutineScreen : Screen("Routine", Icons.Filled.AddTask , "routine/{id}")
    object ExecuteRoutineScreen : Screen("ExecuteRoutine", Icons.Filled.Accessibility, "execute_routine/{id}")
    object SearchScreen : Screen("Searcher", Icons.Filled.Search, "seach")
    object ProfileScreen : Screen("Profile", Icons.Filled.Person, "profile")
}