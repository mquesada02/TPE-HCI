Instalación del API:
--------------------
1) Descomprimir el archivo "API v3.0.2 Installer.zip" en el directorio de instalación.
2) Descargar de https://nodejs.org/en/ la versión 18.0.0 o superior de node.js correspondiente a la plataforma.
...
4) Aguardar a que se descarguen e instalen todos los módulos necesarios y que en la consola se muestre la leyenda "added YYY packages from ZZZ contributors and audited YYY packages in WWW.WWWs found KK vulnerabilities".
...
2) Copiar el archivo "exercise.sqlite3" que se encuentra en el archivo "API v3.0.2 Installer.zip" a el subdirectorio "db" del directorio de instalación.